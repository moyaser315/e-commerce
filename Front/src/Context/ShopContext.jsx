...
const ShopContextProvider = (props) => {
  ...
  const addToCart = async (itemId) => {
    try {
      ...
      const cartResponse = await axios.get(`${hostname}/cart`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
        },
      });
      ...
      const response = await axios.put(`${hostname}/cart`, updatedItem, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
        },
  ...
  const removeFromCart = async (itemId) => {
    try {
      ...
      // Send the updated item back to the backend
      const response = await axios.put(`${hostname}/cart`, existingItem, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
        },
  ...
  const clearCart = async () => {
    try {
      ...
      for (const item of updatedItems) {
        await axios.put(`${hostname}/cart`, item, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
          },
