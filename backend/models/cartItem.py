...
class CartItem(Base):
    ...
    # relations
    __productID: Mapped[int] = mapped_column("productID", ForeignKey("products.id", ondelete="CASCADE", onupdate="CASCADE"), primary_key=True)
    product: Mapped[Product] = relationship()
    
    __buyerID: Mapped[int] = mapped_column("buyerID", ForeignKey("buyers.id", ondelete="CASCADE", onupdate="CASCADE"), primary_key=True)
